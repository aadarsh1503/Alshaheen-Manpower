...
const TechnicalSkills = () => {
  ...
  <div>
    <h2 className="text-2xl lg:text-5xl font-bold font-raleway text-lightblue mb-4">SOFT SKILLS TRAINING</h2>
    <div className="mb-1">
      <h3 className="text-base lg:text-lg font-semibold font-raleway text-DarkRed">ENGLISH BASICS COMMUNICATION</h3>
      <ul className="text-gray-600 space-y-1 text-base lg:text-lg font-raleway list-none">
  ...
  <div>
    <h3 className="text-base lg:text-lg font-semibold font-raleway text-red-600">PERSONAL GROOMING</h3>
    <p className="text-gray-600 text-base lg:text-lg font-raleway">
