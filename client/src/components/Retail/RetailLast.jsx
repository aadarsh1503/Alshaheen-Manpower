          ...
          <div className="w-full lg:w-1/2 h-auto lg:h-full flex flex-col justify-start">
            ...
            <div className="bg-lightgreen text-white p-6 lg:p-20">
              <ul className="space-y-2 text-sm lg:text-lg">
                ...
                <li><span className="text-white">|</span> Initial Interview</li>
                <li><span className="text-white">|</span> Assessment & Skills Evaluation</li>
                <li><span className="text-white">|</span> Final Interview</li>
                <li><span className="text-white">|</span> Job Offer</li>
                <li><span className="text-white">|</span> Onboarding & Training</li>
              </ul>
            </div>
          </div>
        </div>
