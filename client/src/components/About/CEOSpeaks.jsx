  ...
  return (
    <div className="bg-gray-100 p-8 md:px-20 lg:px-40">
      ...
      <p className="text-gray-700 mb-6">
        Nearly fifty years ago, AL SHAHEEN MANPOWER was founded with a dream. A dream to fulfill human potential.
        It is a dream that we work on every day. Today, AL SHAHEEN MANPOWER opens doors for international migrant workers
        ...
        created job-specific training courses to ensure that all workers deployed by AL SHAHEEN MANPOWER arrive job-ready.
      </p>
      <p className="text-gray-700 mb-6">
        Continually expanding our reach, we currently recruit from 32 countries across South Asia,
        South-East Asia, Africa, Middle East, Eastern Europe, and Russia. AL SHAHEEN MANPOWER is committed to expanding
        ...
        life cycle. As AL SHAHEEN MANPOWER enters the sixth decade of its life, the pursuit of our dream is stronger than
